...
private:
    ...
    void SLogHandleLocalAppend(LocalOp* op);
    void SLogHandleLocalRead(LocalOp* op);
    ...
    void SLogOnRecvNewIndexData(const protocol::SharedLogMessage& message,
                                std::span<const char> payload);
    void SLogOnRecvResponse(const protocol::SharedLogMessage& message,
                            std::span<const char> payload);
