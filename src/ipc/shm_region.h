...
std::unique_ptr<ShmRegion> ShmOpenByPath(const std::string& full_path, bool readonly = true);
...
private:
    ...
    friend std::unique_ptr<ShmRegion> ShmOpenByPath(const std::string& full_path, bool readonly);
